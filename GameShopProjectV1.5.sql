...
('2026-03-15 10:00:00', 1, 2, 1),
('2026-03-15 11:30:00', 2, 4, 2),
('2026-03-16 12:15:00', 3, 6, 3),
('2026-03-16 14:20:00', 4, 8, 1),
('2026-03-16 16:45:00', 5, 2, 2),
('2026-03-17 09:30:00', 6, 4, 3),
('2026-03-17 13:10:00', 7, 6, 1),
('2026-03-17 15:50:00', 8, 8, 2),
('2026-03-17 18:05:00', 9, 2, 3),
('2026-03-18 10:20:00', 10, 4, 1),
('2026-03-18 11:00:00', 11, 6, 2),
('2026-03-18 12:30:00', 12, 8, 3),
('2026-03-18 13:45:00', 13, 2, 1),
('2026-03-18 14:15:00', 14, 4, 2),
('2026-03-18 15:00:00', 15, 6, 3);
...
SELECT p.p_name, b.b_name, st.st_quantity
FROM Stock st
...
SELECT con.con_name, p.p_name, p.p_price
FROM Consoles con
JOIN Products p ON con.con_id = p.con_id
WHERE con.con_name = 'PlayStation 5';

-- Empleado de una sucursal especifica
SELECT e.e_name, e.e_lastName, e.e_email, b.b_name
FROM Employees e
JOIN Tickets t ON e.e_id = t.e_id
